...
namespace math
{
	...
	public:
		...
		MATH_FUNCTION const vector<T, 2U>& operator=(const vector<T, 2U>& v)
		{
			x = v.x;
			y = v.y;
			return *this;
		}
		MATH_FUNCTION const vector<T, 2U>& operator=(volatile const vector<T, 2U>& v)
		{
			x = v.x;
			y = v.y;
			return *this;
		}
		MATH_FUNCTION const volatile vector<T, 2U>& operator=(const vector<T, 2U>& v) volatile
		{
			x = v.x;
			y = v.y;
			return *this;
		...
		MATH_FUNCTION friend inline const vector operator+(const vector& a, const vector& b)
		{
			return vector(a.x + b.x, a.y + b.y);
		}

		MATH_FUNCTION friend inline const vector operator+(const vector& a, T b)
		{
			return vector(a.x + b, a.y + b);
		}

		MATH_FUNCTION friend inline const vector operator+(T a, const vector& b)
		{
		...
		MATH_FUNCTION friend inline const vector operator-(T b, const vector& a)
		{
			return vector(b - a.x, b - a.y);
		}

		MATH_FUNCTION friend inline const vector operator*(T a, const vector& v)
		{
			return vector(a * v.x, a * v.y);
		}

		MATH_FUNCTION friend inline const vector operator*(const vector& v, T a)
		{
			return a * v;
		}
		...
		MATH_FUNCTION friend inline T dot(const vector& a, const vector& b)
		{
			return a.x * b.x + a.y * b.y;
		}

		MATH_FUNCTION friend inline vector abs(const vector& v)
		{
			return vector(abs(v.x), abs(v.y));
		}

		MATH_FUNCTION friend inline vector floor(const vector& v)
		{
			return vector(floor(v.x), floor(v.y));
		}

		MATH_FUNCTION friend inline vector ceil(const vector& v)
		{
			return vector(ceil(v.x), ceil(v.y));
		}

		MATH_FUNCTION friend inline vector max(const vector& v, T c)
		{
			return vector(max(v.x, c), max(v.y, c));
		}
		MATH_FUNCTION friend inline vector max(T c, const vector& v)
		{
			return vector(max(v.x, c), max(v.y, c));
		}
		MATH_FUNCTION friend inline vector min(const vector& v, T c)
		{
			return vector(min(v.x, c), min(v.y, c));
		}
		MATH_FUNCTION friend inline vector min(T c, const vector& v)
		{
			return vector(min(v.x, c), min(v.y, c));
		}

		MATH_FUNCTION friend inline vector min(const vector& a, const vector& b)
		{
			return vector(min(a.x, b.x), min(a.y, b.y));
		}
		MATH_FUNCTION friend inline vector max(const vector& a, const vector& b)
		{
			return vector(max(a.x, b.x), max(a.y, b.y));
		}
		MATH_FUNCTION friend inline T min(const vector& a)
		{
			return min(a.x, a.y);
		}
		MATH_FUNCTION friend inline T max(const vector& a)
		{
			return max(a.x, a.y);
		}

		MATH_FUNCTION friend inline T length(const vector& v)
		{
			return sqrt(dot(v, v));
		}

		MATH_FUNCTION friend inline vector normalize(const vector& v)
		{
			return v * rcp(length(v));
		}

		MATH_FUNCTION friend inline vector pow(const vector& v, T exponent)
		{
			return vector(pow(v.x, exponent), pow(v.y, exponent));
		}

		MATH_FUNCTION friend inline vector lerp(const vector& a, const vector& b, T t)
		{
			return vector(lerp(a.x, b.x, t), lerp(a.y, b.y, t));
		}

		MATH_FUNCTION friend inline vector rcp(const vector& v)
		{
			return vector(rcp(v.x), rcp(v.y));
		}

		MATH_FUNCTION inline bool operator==(const vector& v) const
		{
			return x == v.x && y == v.y;
		}
		MATH_FUNCTION inline bool operator!=(const vector& v) const
	...
	public:
		...
		MATH_FUNCTION const vector<T, 3U>& operator=(const vector<T, 3U>& v)
		{
			x = v.x;
			y = v.y;
			z = v.z;
		...
		MATH_FUNCTION const vector<T, 3U>& operator=(volatile const vector<T, 3U>& v)
		{
			x = v.x;
			y = v.y;
			z = v.z;
		...
		MATH_FUNCTION const volatile vector<T, 3U>& operator=(const vector<T, 3U>& v) volatile
		{
			x = v.x;
			y = v.y;
			z = v.z;
		...
		MATH_FUNCTION friend inline vector cross(const vector& a, const vector& b)
		{
	...
	public:
		...
		MATH_FUNCTION const vector<T, 4U>& operator=(const vector<T, 4U>& v)
		{
			x = v.x;
			y = v.y;
			z = v.z;
		...
		MATH_FUNCTION const vector<T, 4U>& operator=(volatile const vector<T, 4U>& v)
		{
			x = v.x;
			y = v.y;
			z = v.z;
		...
		MATH_FUNCTION const volatile vector<T, 4U>& operator=(const vector<T, 4U>& v) volatile
		{
			x = v.x;
			y = v.y;
			z = v.z;
