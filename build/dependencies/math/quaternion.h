...
namespace math
{
	...
	{
		return matrix<T, 3, 3>(T(1) - T(2) * q.y * q.y - T(2) * q.z * q.z, T(2) * q.x * q.y - T(2) * q.z * q.w, T(2) * q.x * q.z + T(2) * q.y * q.w,
		                       T(2) * q.x * q.y + T(2) * q.z * q.w, T(1) - T(2) * q.x * q.x - T(2) * q.z * q.z, T(2) * q.y * q.z - T(2) * q.x * q.w,
		                       T(2) * q.x * q.z - T(2) * q.y * q.w, T(2) * q.y * q.z + T(2) * q.x * q.w, T(1) - T(2) * q.x * q.x - T(2) * q.y * q.y);
	}

	template <typename T>
	MATH_FUNCTION matrix<T, 4, 4> rotationMatrix4(const quaternion<T>& q)
	{
		return matrix<T, 4, 4>(T(1) - T(2) * q.y * q.y - T(2) * q.z * q.z, T(2) * q.x * q.y - T(2) * q.z * q.w, T(2) * q.x * q.z + T(2) * q.y * q.w, T(0),
		                       T(2) * q.x * q.y + T(2) * q.z * q.w, T(1) - T(2) * q.x * q.x - T(2) * q.z * q.z, T(2) * q.y * q.z - T(2) * q.x * q.w, T(0),
		                       T(2) * q.x * q.z - T(2) * q.y * q.w, T(2) * q.y * q.z + T(2) * q.x * q.w, T(1) - T(2) * q.x * q.x - T(2) * q.y * q.y, T(0),
		                       T(0), T(0), T(0), T(1));
	}
