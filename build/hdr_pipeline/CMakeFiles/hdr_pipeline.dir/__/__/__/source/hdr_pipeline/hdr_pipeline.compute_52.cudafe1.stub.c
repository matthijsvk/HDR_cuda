...
extern void __device_stub__Z17downsample_kernelPfPKfjj(float *, const float *, unsigned, unsigned);
...
void __device_stub__Z17downsample_kernelPfPKfjj( float *__par0,  const float *__par1,  unsigned __par2,  unsigned __par3) {  __cudaSetupArgSimple(__par0, 0UL); __cudaSetupArgSimple(__par1, 8UL); __cudaSetupArgSimple(__par2, 16UL); __cudaSetupArgSimple(__par3, 20UL); __cudaLaunch(((char *)((void ( *)(float *, const float *, unsigned, unsigned))downsample_kernel))); }
...
void downsample_kernel( float *__cuda_0,const float *__cuda_1,unsigned __cuda_2,unsigned __cuda_3)
# 98 "/home/matthijs/Documents/Dropbox/_MyDocs/_ku_leuven/Master/CUDA/Projects/HDR2/build/cmake/hdr_pipeline/../../../source/hdr_pipeline/hdr_pipeline.cu"
{__device_stub__Z17downsample_kernelPfPKfjj( __cuda_0,__cuda_1,__cuda_2,__cuda_3);
