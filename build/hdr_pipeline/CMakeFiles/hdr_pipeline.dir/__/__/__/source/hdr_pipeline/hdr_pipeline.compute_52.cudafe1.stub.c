...
extern void __device_stub__Z11blur_kernelPfPKfjj(float *, const float *, unsigned, unsigned);
...
# 1 "hdr_pipeline.compute_52.cudafe1.stub.c"
void __device_stub__Z11blur_kernelPfPKfjj( float *__par0,  const float *__par1,  unsigned __par2,  unsigned __par3) {  __cudaSetupArgSimple(__par0, 0UL); __cudaSetupArgSimple(__par1, 8UL); __cudaSetupArgSimple(__par2, 16UL); __cudaSetupArgSimple(__par3, 20UL); __cudaLaunch(((char *)((void ( *)(float *, const float *, unsigned, unsigned))blur_kernel))); }
...
void blur_kernel( float *__cuda_0,const float *__cuda_1,unsigned __cuda_2,unsigned __cuda_3)
...
{__device_stub__Z11blur_kernelPfPKfjj( __cuda_0,__cuda_1,__cuda_2,__cuda_3);
...
# 1 "hdr_pipeline.compute_52.cudafe1.stub.c"
static void __nv_cudaEntityRegisterCallback( void **__T212) {  __nv_dummy_param_ref(__T212); __nv_save_fatbinhandle_for_managed_rt(__T212); __cudaRegisterEntry(__T212, ((void ( *)(float *, float *, const float *, unsigned, unsigned, float, float))tonemap_kernel), _Z14tonemap_kernelPfS_PKfjjff, (-1)); __cudaRegisterEntry(__T212, ((void ( *)(float *, const float *, unsigned, unsigned))blur_kernel), _Z11blur_kernelPfPKfjj, (-1)); __cudaRegisterEntry(__T212, ((void ( *)(float *, float *, unsigned, unsigned, unsigned, unsigned))downsample_kernel), _Z17downsample_kernelPfS_jjjj, (-1)); __cudaRegisterEntry(__T212, ((void ( *)(float *, const float *, unsigned, unsigned))luminance_kernel), _Z16luminance_kernelPfPKfjj, (-1)); }
